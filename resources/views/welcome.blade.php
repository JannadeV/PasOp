<x-guest-layout>
    <main class="relative h-full">
        <img class="absolute z-40 w-20 md:w-24 lg:w-32 h-auto left-4 -top-8" src="{{ asset('img/dweilhond.png') }}" alt="hond met lang haar">
        <img class="absolute z-40 w-20 md:w-32 lg:w-40 h-auto right-6 top-1/2" src="{{ asset('img/poolhond.png') }}" alt="poolhond">
