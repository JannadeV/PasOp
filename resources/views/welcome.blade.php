<x-guest-layout>
    <main class="relative h-full">
        <img class="absolute z-40 w-20 md:w-32 h-auto left-4 -top-8" src="img/dweilhond.png" alt="hond met lang haar">
        <img class="absolute z-40 w-20 md:w-32 h-auto right-6 top-1/2" src="img/poolhond.png" alt="poolhond">
